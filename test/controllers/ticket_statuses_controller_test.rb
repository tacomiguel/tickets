...
class TicketStatusesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create ticket_status" do
    assert_difference('TicketStatus.count') do
      post ticket_statuses_url, params: { ticket_status: { name: @ticket_status.name, sort: @ticket_status.sort } }
    end
  ...
  test "should update ticket_status" do
    patch ticket_status_url(@ticket_status), params: { ticket_status: { name: @ticket_status.name, sort: @ticket_status.sort } }
